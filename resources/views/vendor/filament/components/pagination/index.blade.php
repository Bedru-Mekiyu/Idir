        ...
        <span class="fi-pagination-overview">
            {{
                trans_choice(
                    ...
                    $paginator->total(),
                    [
                        'first' => $formatNumber($paginator->firstItem() ?? 0),
                        'last' => $formatNumber($paginator->lastItem() ?? 0),
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        <x-filament::pagination.item
                            ...
                            :aria-label="trans_choice('filament::components/pagination.actions.go_to_page.label', $page, ['page' => $formatNumber($page)])"
                            :label="$formatNumber($page)"
